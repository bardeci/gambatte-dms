...
mksquashfs default.gcw0.desktop ./gambatte_sdl/gambatte_sdl gambatte.png manual.txt DefaultDMG.png DefaultGBC.png Default.pal gambatte-gcw0-r572u2-$BDAT.opk -all-root -no-xattrs -noappend -no-exports