...
rm -f gambatte-gcw0-r572-$BDAT.opk

mksquashfs default.gcw0.desktop ./gambatte_sdl/gambatte_sdl gambatte.png manual.txt gambatte-gcw0-r572-$BDAT.opk -all-root -no-xattrs -noappend -no-exports