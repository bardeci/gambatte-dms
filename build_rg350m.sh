...
(cd libgambatte && scons -Q target=rg350m) || exit
echo "cd gambatte_sdl && scons"
(cd gambatte_sdl && scons -Q target=rg350m)
mv gambatte_sdl/gambatte_sdl gambatte_sdl/gambatte-dms.opendingux

rm -f gambatte-dms-rg350m-r572u4-$BDAT.opk

mksquashfs ./dist/gcw0/default.gcw0.desktop ./gambatte_sdl/gambatte-dms.opendingux ./dist/gcw0/gambatte_dms.png ./dist/gcw0/manual.txt gambatte-dms-rg350m-r572u4-$BDAT.opk -all-root -no-xattrs -noappend -no-exports
